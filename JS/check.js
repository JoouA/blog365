...
function check(){
    ...
    if (document.myform.txt_regrealname.value==""){
...
function openwin(x){
    ...
    if (x==""){
        ...
        alert("请输入用户名!"); document.myform.txt_regname.focus();return false;

    }

    else{

        window.open("submit_checkuser.php?x="+x,"newframe","width=200px,height=75px");
