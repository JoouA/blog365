    ...
    <form  name="myform" action="register_deal.php" method="post">
        <table width="85%" border="1" align=center cellpadding=3 cellspacing=2 bordercolor="#FFFFFF" bgcolor="#FFFFFF" class=i_table>
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td width=78% align="left"  class='f_one'>
                    <input name='txt_regname' type=text id="txt_regname" value='' size=20 maxlength=14>
                    <a href="#" onclick="return openwin(document.myform.txt_regname.value);">[检测用户]</a> <font color=red>*</font>
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="left" >
                    <input name=txt_regrealname type=text id="txt_regrealname" size=20 maxlength=75> <font color=red>*</font>
                </td>
            </tr>
            <tr>
            <tr bgcolor="#FFFFFF">
                ...
                <td align="left">
                    <input name=txt_regpwd type=password id="txt_regpwd" size=20 maxlength=75>英文字母或数字等不少于3位<font color=red>*</font>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                <td align="right" valign="middle"> 确认密码</td>
                <td align="left" >
                    <input name='txt_regpwd2' type="password" id="txt_regpwd2" size=20 maxlength=75 onblur="if(this.value!=this.form.txt_regpwd.value) {alert('您两次输入的密码不一致！');myform.txt_regpwd.focus();}">
                    <font color=red>*</font>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                ...
                <input name="txt_birthday" type="text" id="Tel">（日期格式为：yyyy-mm-dd）<font color=red>*</font></span>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
                <td align="right" valign="middle"> Email</td>
                <td align="left"  >
                    <input name=txt_regemail type=text id="txt_regemail" value='' size=35 maxlength=75><font color='#000000'>公开邮箱 <font color=red>*</font></font>
                </td>
            </tr>
            <tr bgcolor="#FFFFFF">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="left" class='f_one'>
                    <table width="106" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="10px" height="47px">
                                <script  type="text/javascript">
                                    //通过下拉列表选择头像时应用该函数
                                    function showlogo(){
                                        document.img.src=" images/head/"+document.myform.txt_ico.options[document.myform.txt_ico.selectedIndex].value;
                                    }
                                </script>
                            </td>
                            <td width="80px"><img src="images/head/0.gif" name="img" width="60px" height="60px"></td>
                            <td width="53px" rowspan="2" align="center"><font color=red>*</font></td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                            <td>
                                <select name="txt_ico" size="1" id="txt_ico" onchange="showlogo()">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="left" class='f_one'>
                    <select name=txt_regsex id="txt_regsex">
