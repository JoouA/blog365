...
for($i=0;$i<4;$i++){
    $num=rand(0,$word-1);
    $img.="<img src=' images/checkcode/".$num.".gif' width='16px' height='16px'>";    //显示随机图片
    $pic.=$str[$num];    //将图片转换成数组中的文字
}
?>
...
<TABLE width="757px" cellPadding=0 cellSpacing=0 style="WIDTH: 755px" align="center">
    ...
    <TR>
        <TD style="VERTICAL-ALIGN: bottom; HEIGHT: 6px" colSpan=3>
            <table width="100%" height="149px"  border="0" cellpadding="0" cellspacing="0" background="images/F_head.jpg" align="center">
                <tr>
                    <td height="51px" align="right">
                        ...
                        <table width="262px" border="0" cellspacing="0" cellpadding="0">
                            <tr align="left">
                                ...
                                <td width="55px"><a href="<?php echo (!isset($_SESSION['username'])?'Regpro.php':'safe.php'); ?>"><span style="FONT-SIZE: 9pt; COLOR: #000000; TEXT-DECORATION: none"><?php echo (!isset($_SESSION['username'])?"博客注册":"安全退出"); ?></span></a></td>
                                <td width="23px">&nbsp;</td>
                            </tr>
                        </table>
                        <br>
